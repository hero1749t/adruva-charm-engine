        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
          {outlets.map((outlet, i) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-4 p-6 rounded-2xl bg-card shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all cursor-pointer group"
            >
              <div className="w-16 h-16 rounded-full bg-red-brand-light flex items-center justify-center group-hover:bg-primary transition-colors">
                <outlet.icon className="w-7 h-7 text-primary group-hover:text-primary-foreground transition-colors" />
              </div>
